...
API_URL = 'https://comtest01.internal.osect.ntt.com/paper/api/v1/createlogdata/post'
""" SaaS連携用APIのURL """
...
SEND_VERSION_API_URL = 'https://comtest01.internal.osect.ntt.com/paper/api/v1/sensor_status/post'
