...
; TCP SYN signatures
; ==================
; added_data : [rule_id, specificity, vulnerability]
...
label = s:unix:Linux:2.6.x[3,1,0]
...
label = s:unix:Linux:2.4.x[4,1,0]
...
label = s:unix:Linux:2.2.x[5,1,0]
...
sig   = 6:128:0:*:mss*45,8:mss,nop,ws,nop,nop,sok:flow:0
...
label = s:win:Windows:XP[101,4,4]
...
label = s:win:Windows:7/8[102,3,0]
...
label = s:unix:FreeBSD:9.x or newer[301,3,3]
sig   = *:64:0:*:65535,6:mss,nop,ws,sok,ts:df,id+:0

label = s:unix:FreeBSD:8.x[302,3,3]
sig   = *:64:0:*:65535,3:mss,nop,ws,sok,ts:df,id+:0

; Catch-all rules:

label = g:unix:FreeBSD:[303,2,0]
...
label = s:unix:OpenBSD:3.x[401,3,0]
sig   = *:64:0:*:16384,0:mss,nop,nop,sok,nop,ws,nop,nop,ts:df,id+:0

label = s:unix:OpenBSD:4.x-5.x[402,3,0]
...
label = s:unix:Solaris:8[501,4,0]
sig   = *:64:0:*:32850,1:nop,ws,nop,nop,ts,nop,nop,sok,mss:df,id+:0

label = s:unix:Solaris:10[502,4,0]
...
label = s:unix:OpenVMS:8.x[601,3,0]
sig   = 4:128:0:1460:mtu*2,0:mss,nop,ws::0

label = s:unix:OpenVMS:7.x[602,3,0]
...
label = s:other:NeXTSTEP:[701,2,0]
...
label = s:unix:Tru64:4.x[801,3,0]
...
label = s:!:NMap:OS detection[902,2,0]
sys   = @unix,@win
...
label = s:unix:p0f:sendsyn utility[1001,2,0]
...
label = s:unix:Linux:3.x[1201,1,0]
...
label = s:unix:Linux:2.4-2.6[1202,1,0]
...
label = s:unix:Linux:2.4.x[1203,1,0]
...
label = s:unix:Linux:2.6.x[1204,1,0]
...
label = s:win:Windows:XP[1301,4,4]
...
label = s:win:Windows:7/8[1302,3,0]
...
label = s:unix:FreeBSD:9.x[1401,3,3]
...
label = s:unix:FreeBSD:8.x[1402,3,3]
...
label = s:unix:FreeBSD:8.x-9.x[1403,3,3]
...
label = s:unix:OpenBSD:5.x[1501,3,0]
...
label = s:unix:Mac OS X:10.x[1601,3,0]
...
label = s:unix:Solaris:6[1701,4,0]
...
label = s:unix:Solaris:8[1702,4,0]
...
label = s:unix:Solaris:10[1703,4,0]
...
label = s:unix:HP-UX:11.x[1801,3,0]
...
label = s:other:OpenVMS:7.x[1901,3,0]
...
label = s:unix:Tru64:4.x[2001,3,0]
